 ...
 *   copy of data.                                                           *
 *   Used in gds_typed_hash_map_set and gds_typed_hash_map_get if parameter copy_data is *
 *   true.                                                                   *
 * - free:                                                                   *
 *   Prototype: void free(void *data);                                       *
 *   Takes a pointer to data and free it.                                    *
 *   Used in gds_typed_hash_map_set, gds_typed_hash_map_del, and gds_typed_hash_map_free if    *
 *   parameter free_data (or free_old_data) is true.                         *
 *****************************************************************************/

#ifndef gds_typed_hash_map_h_included
#define gds_typed_hash_map_h_included
...
typedef struct gds_typed_hash_map_s gds_typed_hash_map_t;
 ...
 *         Failure => NULL */
gds_typed_hash_map_t *
gds_typed_hash_map_new(
 ...
 *         Failure => NULL */
char *
gds_typed_hash_map_get_type_name(
...
int8_t
gds_typed_hash_map_set_type_name(
	gds_typed_hash_map_t *h,
	const char *type_name
);
 ...
 *         Failure => 0 */
uint32_t
gds_typed_hash_map_get_map_size(
	gds_typed_hash_map_t *h
);
...
int8_t
gds_typed_hash_map_set_map_size(
	gds_typed_hash_map_t *h,
	uint32_t map_size
);
 ...
 *         Failure => NULL */
gds_hash_cb
gds_typed_hash_map_get_hash_cb(
	gds_typed_hash_map_t *h
);
 ...
 *         Failure => a negative value */
int8_t
gds_typed_hash_map_set_hash_cb(
	gds_typed_hash_map_t *h,
	gds_hash_cb hash_cb
);
 ...
 * hash_map_set_key */
gds_iterator_t *
gds_typed_hash_map_iterator_keys_new(
	gds_typed_hash_map_t *h
);

/* Create an iterator on hash data */
gds_iterator_t *
gds_typed_hash_map_iterator_data_new(
	gds_typed_hash_map_t *h
);
...
#endif /* Not gds_typed_hash_map_h_included */
