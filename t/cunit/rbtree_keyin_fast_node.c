...
void t_rbtree_keyin_fast_node_new(void)
{
	...
	n = gds_rbtree_keyin_fast_node_new(NULL);
	CU_ASSERT(NULL != n);
	CU_ASSERT(NULL == gds_rbtree_keyin_fast_node_get_data(n));
	gds_rbtree_keyin_fast_node_free(n, NULL);

	n = gds_rbtree_keyin_fast_node_new(t);
	CU_ASSERT(NULL != n)
	CU_ASSERT(t == gds_rbtree_keyin_fast_node_get_data(n));
	gds_rbtree_keyin_fast_node_free(n, NULL);
...
void t_rbtree_keyin_fast_node_get_data(void)
{
	...
	GDS_ASSERT_THROW(BadArgumentException, gds_rbtree_keyin_fast_node_get_data(NULL));

	data = gds_rbtree_keyin_fast_node_get_data(n);
	CU_ASSERT(NULL != data);
	CU_ASSERT(t == data);
...
void t_rbtree_keyin_fast_node_set_data(void)
{
	...
	GDS_ASSERT_THROW(BadArgumentException, gds_rbtree_keyin_fast_node_set_data(NULL, NULL, NULL   ));
	GDS_ASSERT_THROW(BadArgumentException, gds_rbtree_keyin_fast_node_set_data(NULL, NULL, free_cb));
	GDS_ASSERT_THROW(BadArgumentException, gds_rbtree_keyin_fast_node_set_data(NULL, t   , NULL   ));
	GDS_ASSERT_THROW(BadArgumentException, gds_rbtree_keyin_fast_node_set_data(NULL, t   , free_cb));

	/* Set NULL as data. */
	CU_ASSERT(0 == gds_rbtree_keyin_fast_node_set_data(n, NULL, NULL   ));
	CU_ASSERT(0 == gds_rbtree_keyin_fast_node_set_data(n, NULL, free_cb));

	/* Set t as data. */
	CU_ASSERT(0 == gds_rbtree_keyin_fast_node_set_data(n, test_alloc(t), NULL));
	CU_ASSERT(0 == gds_rbtree_keyin_fast_node_set_data(n, t, free_cb));
