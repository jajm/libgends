...
void t_rbtree_node_set_data(void)
{
	...
	CU_ASSERT(0 == gds_rbtree_node_set_data(n   , NULL, alloc_cb, NULL   ));
	CU_ASSERT(0 == gds_rbtree_node_set_data(n   , NULL, alloc_cb, free_cb));
	CU_ASSERT(0 == gds_rbtree_node_set_data(n   , NULL, NULL    , free_cb));

	/* Set t as data. */
	CU_ASSERT(0 == gds_rbtree_node_set_data(n   , t   , NULL    , NULL   ));
	CU_ASSERT(0 == gds_rbtree_node_set_data(n   , t   , alloc_cb, NULL   ));
